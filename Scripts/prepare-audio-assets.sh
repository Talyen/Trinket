...
prepare_music() {
  ...
  trinket_asset_track_mktemp tracks_temp
  trinket_asset_track_mktemp menu_temp
  trinket_asset_track_mktemp battle_temp
  trinket_asset_track_mktemp boss_temp
  trinket_asset_track_mktemp seen_ids_temp
  trinket_asset_track_mktemp seen_assets_temp
  trinket_asset_track_mktemp seen_boss_ids_temp
  trinket_asset_track_mktemp active_tracks_temp
  ...
  while IFS=$'\t' read -r kind_col id asset_name source_path boss_enemy_id looping volume_gain || [[ -n "${kind_col:-}" ]]; do
    ...
    if ! trinket_asset_validate_bool "Looping value" "$id" "$looping"; then
      exit 1
    fi
...
prepare_sfx() {
  ...
  trinket_asset_track_mktemp clips_temp
  trinket_asset_track_mktemp ids_temp
  trinket_asset_track_mktemp seen_sfx_ids_temp
  trinket_asset_track_mktemp seen_symbols_temp
  trinket_asset_track_mktemp seen_sfx_assets_temp
  trinket_asset_track_mktemp active_clips_temp
  local processed_count=0
  trinket_asset_begin_state_file "$state_file" "$GENERATOR"
...
SWIFT
  ...
  trinket_asset_track_mktemp generated_temp
  cat > "$generated_temp" <<SWIFT
// Generated by $GENERATOR. Do not edit directly.
