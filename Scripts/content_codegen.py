...
try:
    from content_codegen_modifiers import (
        ...
        publicize as publicize,
        swift_brace_delta as swift_brace_delta,
    )
    from content_codegen_triggers import (
        _trigger_families as _trigger_families,
        parse_trigger_tokens as parse_trigger_tokens,
        triggers_swift as triggers_swift,
    )
except ModuleNotFoundError:
    from Scripts.content_codegen_modifiers import (
        MEMBER as MEMBER,
        NESTED_TYPE as NESTED_TYPE,
        TOP_LEVEL as TOP_LEVEL,
        modifier_token_to_swift as modifier_token_to_swift,
    ...
    from Scripts.content_codegen_triggers import (
        _trigger_families as _trigger_families,
        parse_trigger_tokens as parse_trigger_tokens,
        triggers_swift as triggers_swift,
    )
