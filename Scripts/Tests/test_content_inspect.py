...
class ContentInspectTests(ScriptRegressionTestCase):
    def test_name_lookup_follows_fields_to_schema_rules_source_and_tests(self) -> None:
        ...
        self.assertIn('trigger_families/control.json:', output)
        self.assertIn('CombatTriggerEngine+BlockAndDefense.swift:', output)
        self.assertIn('TalentCatalogRoundTripTests+FinalCompanions.swift:', output)
