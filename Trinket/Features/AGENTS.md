...
- New player flows need stable accessibility identifiers. Add or extend UI smoke only when the keep/drop rubric in `Docs/Platform/Testing.md` applies. Accessibility baseline: PD-007.
- Feature changes must pass path-scoped verification before handoff.

Homestead layout: [Homestead.md](../../Docs/Product/Homestead.md). Battle layout: `Packages/TrinketBattleFeature/README.md` (hand size: `Packages/BattleEngine/README.md`).
