...
- New player flows need stable accessibility identifiers. Add or extend UI smoke only when the keep/drop rubric in [Testing](../../Docs/Platform/Testing.md) applies. Accessibility baseline: [PD-014](../../Docs/Product/Decisions.md).
