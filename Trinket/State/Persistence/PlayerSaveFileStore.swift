...
struct PlayerSaveFileStore {
    static let fileName = "PlayerSave.json"
    static let backupFileName = "PlayerSave.json.bak"
    static let legacyJourneyKey = "PlayerJourneyStore.current"

    private let directoryURL: URL
    private let fileManager: FileManager
    private let encoder: JSONEncoder
    private let decoder: JSONDecoder
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "Trinket", category: "PlayerSave")
    ...
    func save(_ playerSave: PlayerSave) {
        ensureDirectoryExists()
