...
struct CloudKitPlayerSaveSync: PlayerSaveSyncing {
    static let recordType = "PlayerSave"
    static let recordName = "primary"
    static let containerIdentifier = "iCloud.com.ryanmcintire.Trinket"
    ...
    init(container: CKContainer = CKContainer(identifier: CloudKitPlayerSaveSync.containerIdentifier)) {
