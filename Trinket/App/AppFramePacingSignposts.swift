...
enum AppFramePacingSignposts {
    static let subsystem = BattleFramePacingSignposts.subsystem
    static let category = "AppNavigation"
    ...
    enum Name {
        ...
        static let sheetPresent: StaticString = "SheetPresent"
        static let navigationPush: StaticString = "NavigationPush"
        static let stageSelectBattleActivate: StaticString = "StageSelectBattleActivate"
    }
