...
enum BattlePerformanceFixture {
    /// Shared by every Battle performance launch so isolation variants resolve
    /// the same hand, playable card, and feedback events.
    static let seed: UInt64 = 0x5452_494E
}
