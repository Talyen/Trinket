...
| CloudKit distribution | Keep the checked-in distribution default defined in the [storage contract](../../../Docs/AgentContext/persistence-storage.md#cloudkit-preparation); explicitly enabled builds use complete-save sync under that contract. | Wider enablement follows the [required readiness gates](../../../Docs/Platform/CloudKitPreShipChecklist.md#required-readiness-gates); controlled internal builds are distinct from the distributed default. |
