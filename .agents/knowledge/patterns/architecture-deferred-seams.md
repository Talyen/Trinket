...
| CloudKit distribution | Ordinary builds default to local-only; explicitly enabled builds use complete-save sync under the [storage contract](../../../Docs/AgentContext/persistence-storage.md#cloudkit-preparation). | Wider enablement follows the [required readiness gates](../../../Docs/Platform/CloudKitPreShipChecklist.md#required-readiness-gates); controlled internal builds are distinct from the distributed default. |
