...
- Use Dynamic Type text styles and `@ScaledMetric` where a visual metric should follow type — they are free native behavior, not accommodations. Do not add layouts whose only job is re-flowing at accessibility text sizes (PD-007).
