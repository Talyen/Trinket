...
Fast iteration loop: `./Scripts/test.sh unit` or `./Scripts/test-package.sh <Package>`. Verification tiers, gate composition, and script routing live in `Scripts/README.md`.
