...
|--------|-------------------|
| Disk / encoder I/O | `Packages/TrinketPersistence/`; save-store temp-dir harnesses in `Packages/TrinketPersistence/Sources/TrinketPersistenceTestSupport/` (`SaveTestSupport`) — not `TrinketTestSupport` |
