...
| Plan | Closed | Outcome |
|------|--------|---------|
| Battle card cues | 2026-09-08 | Reworked The Patient Edge around partner-first attacks with saved-power compatibility; added artwork-first recipient cues, resource-use previews, and denial feedback for taps, drags, and Auto Battle; covered interrupted and rapid input, and isolated the headless routing test from inherited smoke settings. |
