...
| Combat semantic architecture | 2026-09-09 | Implemented typed operations, actor-relative targets, action/effect ownership, atomic turn playback, and authoritative preparation/rewards; final handoff, Battle smoke, and six Battle performance scenarios passed; full-app performance retained a Collection sampling failure and observational frame-budget misses |
