...
- Tier effects use standard bold keyword colors. Daily production pairs compact material artwork with a bold quantity and resource name inside “Produces … per day,” without chip chrome.
