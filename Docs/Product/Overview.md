...
What the player sees, in player terms. Locked rules live in
[Decisions.md](Decisions.md); visual direction in
[ArtworkStyleGuide.md](ArtworkStyleGuide.md).

| Surface | What it is |
|---|---|
| Play | The mode hub: choose a Journey, Labyrinth, Spire, or encounter, then enter three-card-hand combat with a Hero and Companion. |
