...
| PD-028 | Earned Gold fills available wallet space and only its excess becomes XP; item quality follows the highest encounter level won, capped at loot level 40. | Apply one settlement to previews and claims; a winning battle uses its own level for that battle's item roll. |
