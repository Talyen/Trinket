...
- **Push gates**: `./Scripts/agent-push-gate.sh` checks post-commit generation completeness only — no style or compile. Landing policy is owned by root `AGENTS.md` and [Verification.md](../Platform/Verification.md).
