...
Give a view the narrowest owner it needs: `PlaySession`, a specific encounter session,
`BattleSession`, or a Battle read lane. Do not pass `AppState` through a feature tree
when explicit values and actions suffice.
