...
| Battle Gold flow and reward values | TrinketCore / TrinketContent | Core carries gross gains/spending fields for compatibility; current combat content is gain-only |
