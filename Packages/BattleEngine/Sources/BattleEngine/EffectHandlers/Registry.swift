...
public enum EffectHandlers {
    public static let all: [EffectKind: any BattleEffectHandler] = [
        ...
        .nextHolyStrike: FlagEffectHandler(
            ...
            amount: 0,
            keyword: .holy,
            summaryText: EffectKind.requiredBattleSummaryPhrase(for: .nextHolyStrike),
        ),
        .nextStrikeDouble: FlagEffectHandler(
            ...
            amount: 0,
            keyword: .physical,
            summaryText: EffectKind.requiredBattleSummaryPhrase(for: .nextStrikeDouble),
        ),
        ...
        .evadeNextHit: FlagEffectHandler(
            ...
            amount: 0,
            keyword: .dodge,
            summaryText: EffectKind.requiredBattleSummaryPhrase(for: .evadeNextHit),
        ),
        ...
        .freezeNextAttacker: FlagEffectHandler(
            ...
            amount: 0,
            keyword: .freeze,
            summaryText: EffectKind.requiredBattleSummaryPhrase(for: .freezeNextAttacker),
        ),
