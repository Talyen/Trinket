...
struct CombatTriggerTalentRecoveryTests {
    @Test func `overheal converts to block for healed target`() {
    ...
    @Test func `overheal conversion ignores target wisdom`() {
    ...
    @Test func `weaken soul reduces enemy strength on leech`() {
        var battle = BattleStateTestFactory.makeBattle(
    ...
    @Test func `mass cleanse does not treat companion debuffs as original keyword`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(),
            companion: BattleTestFixtures.passiveCompanion(),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 100),
    ...
    @Test func `auto cleanse uses living allies only`() {
    ...
    @Test func `consecration cleanse grants spellbreak shield`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(),
            companion: BattleTestFixtures.passiveCompanion(),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 40),
    ...
    @Test func `auto cleanse grants spellbreak shield`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(),
            companion: BattleTestFixtures.passiveCompanion(),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 40),
    ...
    @Test func `arcane cleansing grants spellbreak shield`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(),
            companion: BattleTestFixtures.passiveCompanion(),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 40),
    ...
    @Test func `overheal converts to max health before block`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(maxHealth: 20),
            companion: BattleTestFixtures.passiveCompanion(),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 40),
    ...
    @Test func `fae fortune heals the cleanser not the cleanse target`() throws {
    ...
    @Test func `panther leech overheal caps at four`() {
    ...
    @Test func `bear vital armor caps at ten max health and tracks cumulatively`() {
    ...
    @Test func `purifying aura on companion accelerates hero debuffs`() {
        var battle = BattleStateTestFactory.makeBattle(
    ...
    @Test func `endless legion restores health when deaths door expires`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(),
            companion: BattleTestFixtures.passiveCompanion(maxHealth: 20),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 40),
    ...
    @Test func `vital infusion overheal caps per event on healed ally`() {
        var battle = BattleStateTestFactory.makeBattle(
            hero: BattleTestFixtures.passiveHero(maxHealth: 20),
            companion: BattleTestFixtures.passiveCompanion(maxHealth: 20),
            enemy: BattleTestFixtures.silentEnemy(maxHealth: 100),
