...
@Suite struct EnemyCatalogTests {
    ...
    func eachEnemyHasBasicSkillUltimate(enemy: Enemy) {
        ...
        #expect(loadout.basic != nil, "\(enemy.name) should have a basic ability")
        #expect(loadout.skill != nil, "\(enemy.name) should have a skill ability")
        #expect(loadout.ultimate != nil, "\(enemy.name) should have an ultimate ability")
    }
