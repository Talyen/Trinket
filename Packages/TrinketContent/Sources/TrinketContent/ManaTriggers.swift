...
public struct ManaTriggers: Equatable, Hashable, Sendable {
    ...
    public var firstTurnBonusDraw: Int = 0
    ...
    public init(
        ...
        // Copy and engine treat this as the first Skill each battle; the field name is historical.
        firstSkillCardPlaysTwicePerBattle: Bool = false,
        onReachZeroManaRestoreMana: Int = 0,
        firstTurnBonusDraw: Int = 0,
        ...
        self.firstTurnBonusDraw = firstTurnBonusDraw
...
extension ManaTriggers {
    mutating func merge(_ other: Self) {
        ...
        firstTurnBonusDraw += other.firstTurnBonusDraw
...
extension ManaTriggers {
    ...
    init(from values: DefaultingTriggerDecoder, legacyAffix: DefaultingTriggerDecoder?) throws {
        try self.init(
            ...
            gainManaBlockFlat: values.decode(
                Int.self,
                "gainManaBlockFlat",
                default: legacyAffix?.decode(Int.self, "gainManaBlockFlat", default: 0) ?? 0
            ),
            leechRestoreManaFlat: values.decode(
                Int.self,
            ...
            firstTurnBonusDraw: values.decode(Int.self, "firstTurnBonusDraw", default: 0),
    ...
    func encode(to container: inout KeyedEncodingContainer<TriggerCodingKey>) throws {
        ...
        try container.encodeNonDefault(firstTurnBonusDraw, "firstTurnBonusDraw", default: 0)
