...
public struct HealingTriggers: Equatable, Hashable, Sendable {
    ...
    public var onLeechDrainMana: Int = 0
    ...
    public init(
        ...
        self.onLeechDrainMana = onLeechDrainMana
...
extension HealingTriggers {
    mutating func merge(_ other: Self) {
        ...
        overhealConvertsToMaxHealthPerEvent = max(
            overhealConvertsToMaxHealthPerEvent,
            other.overhealConvertsToMaxHealthPerEvent
        )
        ...
        onLeechDrainMana += other.onLeechDrainMana
...
extension HealingTriggers {
    ...
    init(from values: DefaultingTriggerDecoder, legacyAffix _: DefaultingTriggerDecoder?) throws {
        try self.init(
            ...
            onLeechDrainMana: values.decode(Int.self, "onLeechDrainMana", default: 0),
    ...
    func encode(to container: inout KeyedEncodingContainer<TriggerCodingKey>) throws {
        ...
        try container.encodeNonDefault(regenerationAmount, "regenerationAmount", default: 0)
        try container.encodeNonDefault(regenerationIntervalTurns, "regenerationIntervalTurns", default: 0)
        ...
        try container.encodeNonDefault(leechHealingMultiplier, "leechHealingMultiplier", default: 1)
        ...
        try container.encodeNonDefault(onLeechDrainMana, "onLeechDrainMana", default: 0)
