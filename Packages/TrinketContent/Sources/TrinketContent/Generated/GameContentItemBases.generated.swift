...
enum GameContentItemBasesGenerated {
    static let itemBaseTypes: [ItemBaseType] = {
        ...
        list.append(ItemBaseType(id: "greatsword", name: "Greatsword", slot: .weapon, keywordAffinities: [.physical, .bleed, .stun, .holy]))
        ...
        list.append(ItemBaseType(id: "shortsword", name: "Shortsword", slot: .weapon, keywordAffinities: [.physical, .bleed, .poison, .gold]))
        ...
        list.append(ItemBaseType(id: "leather_armor", name: "Leather Armor", slot: .armor, keywordAffinities: [.physical, .block, .health, .poison, .leech, .bleed, .gold]))
