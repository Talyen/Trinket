...
public enum GameContentEnemiesGenerated {
    public static let enemies: [Enemy] = [
        ...
        Enemy(combatant: Combatant(id: "mud_elemental", name: "Mud Elemental", role: .enemy, maxHealth: Enemy.defaultMaxHealth, abilities: [.block, .briarShield, .plateMail], primaryStats: PrimaryStats(strength: 4, agility: 3, toughness: 9, intellect: 3, wisdom: 3))),
        ...
        Enemy(combatant: Combatant(id: "goblin", name: "Goblin", role: .enemy, maxHealth: Enemy.defaultMaxHealth, abilities: [.slash, .sapArrow, .packTactics], primaryStats: PrimaryStats(strength: 3, agility: 7, toughness: 2, intellect: 3, wisdom: 2))),
