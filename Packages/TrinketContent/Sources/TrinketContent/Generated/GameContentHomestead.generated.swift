            ...
            tiers: [
                HomesteadNodeTier(
                    ...
                    bonus: HomesteadBonus(
                        ...
                        description: "Decreases Hero Poison damage taken by 10%"
                    )
                ),
                HomesteadNodeTier(
                    tier: 2,
                    ...
                    bonus: HomesteadBonus(
                        title: "Poison Resistance",
                        description: "Decreases Hero Poison damage taken by 20%"
                    )
                ),
                HomesteadNodeTier(
                    tier: 3,
                    ...
                    bonus: HomesteadBonus(
                        title: "Poison Resistance",
                        description: "Decreases Hero Poison damage taken by 30%"
                    )
                )
            ]
        ),
