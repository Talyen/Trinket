...
extension ControlTriggers {
    ...
    init(from values: DefaultingTriggerDecoder, legacyAffix: DefaultingTriggerDecoder?) throws {
        try self.init(
            freezeControlVulnerabilityPercent: values.decode(Double.self, "freezeControlVulnerabilityPercent", default: 0),
            ...
            dodgeDealStunFlat: values.decode(
                Int.self,
                "dodgeDealStunFlat",
    ...
    func encode(to container: inout KeyedEncodingContainer<TriggerCodingKey>) throws {
        try container.encodeNonDefault(freezeControlVulnerabilityPercent, "freezeControlVulnerabilityPercent", default: 0)
