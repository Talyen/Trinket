...
public extension StageSelectRowPresentation where Item == ContractOffer {
    static func contractRows(offers: [ContractOffer], inventory: PlayerInventoryState) -> [Self] {
        offers.compactMap { offer in
            ...
            return Self(
                ...
                modifiers: [ModifierCaptionPresentation(ContractsCompletion.effectiveModifier(for: offer, inventory: inventory))],
            )
        }
    }
}
