...
public extension AccessibilityID {
    enum FullGame {
        public static let offer = "Full Game Offer"
        public static let purchase = "Full Game Purchase"
        public static let close = "Full Game Close"
        public static let restore = "Full Game Restore"
