...
struct PrimaryStatsRulesTests {
    @Test func `primary stats total calculates sum`() throws {
    ...
    @Test func `diminishing returns percent calculates correctly`() throws {
    ...
    @Test func `stat damage bonus percent uses correct stat and curve`() throws {
    ...
    @Test func `contested dodge subtracts attacker agility`() throws {
    ...
    @Test func `contested enemy dodge compresses high dodge with falloff`() throws {
    ...
    @Test func `toughness mitigation matches formula`() throws {
    ...
    @Test func `control meter threshold scales with agility and rounds base health`() throws {
    ...
    @Test func `contested critical subtracts defender toughness`() throws {
    ...
    @Test func `contested critical is zero for non crittable keywords`() throws {
    ...
    @Test func `enemy archetype chance caps match design`() throws {
    ...
    @Test func `negative stat inputs return zero for damage bonus`() throws {
